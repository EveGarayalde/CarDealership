...
public class Overseer {
	...
	private String[] names = {"2022 Alfa Romeo Giulia", "2022 Audi A3", "2022 Buick Enclave", "2022 Chevrolet Corvette", "2022 Fiat 500X"};
	private String[] colors = {"Blue", "Red", "Black", "White", "Gray", "Yellow"};
		...
		while(loop) {
			...
			if(x == 0) {
				...
				if(b == 0) {
					...
					String s = JOptionPane.showInputDialog(null, "Which car models would you like to view?\nNames of Models: Alfa, Audi, Buick, Corvette, Fiat ", "View Models", 3);
					JOptionPane.showMessageDialog(null, cars.drawMap(s));
				}
			}
			else if(x == 1) {
